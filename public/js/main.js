WordFinder = (function() {
    ...
    var init = function() {
        ...
        _lang = {
            'text': jQuery('#language_select option:selected').text(),
        ...
        //search the string when the button is clicked
        jQuery('#searchButton').on('click', function() {
            _compareString = _$textInput.val();
            _$outputNode.text('Searching...');
    ...
    var getDict = function(lang) {
        ...
        _dictMap = {};
        jQuery.get('/api/1.0/get_dictionary', {
            'lang': lang.val
        })
            .done(function(data) {
            if (data !== undefined) {
    ...
    var findWordsFromAPI = function(langString, compareString) {
        if (_pendingSearch === false) {
            ...
            jQuery.get("/api/1.0/find_words", {
                "lang": langString,
                "letterString": compareString
            })
                .done(function(data) {
                _pendingSearch = false;
                if (data !== undefined) {
